...
a = np.load(WHERE_FROM_LOAD + '/eval_burst_infer_com.npy')
...
##
print("0ne device")
a = np.load(WHERE_FROM_LOAD + '/eval_one_infer_com.npy')
...
a = np.load(WHERE_FROM_LOAD + '/eval_one_acc_com.npy')
one_accuracy = np.array(a[0])
one_accuracy_std = np.array(a[1])
print(one_accuracy)
print(one_accuracy_std)
a = np.load(WHERE_FROM_LOAD + '/eval_one_energy_com.npy')
...
plt.xlabel('average computing power (MFLOPS)')
...
#
# # print("BASS")
# # a = np.load('C:/Users/user/PycharmProjects/SplitComputing/eval_rand_infer_com.npy')
# # rand_inference_latency = np.array(a)
# # print(rand_inference_latency)
# # a = np.load('C:/Users/user/PycharmProjects/SplitComputing/eval_rand_acc_com.npy')
# # rand_accuracy = np.array(a)
# # print(rand_accuracy)
# # a = np.load('C:/Users/user/PycharmProjects/SplitComputing/eval_rand_energy_com.npy')
# # rand_energy_consumption = np.array(a)
# # print(rand_energy_consumption)
# # print()
# # rand_ec = []
# # for i in range(5):
# #     maxindex = np.argmax(rand_energy_consumption[i])
# #     rand_ec.append(rand_energy_consumption[i][maxindex])
# # rand_ec_1 = []
# # for i in range(5):
# #     rand_ec_1.append(rand_energy_consumption[i][0])
# # ##
...
#
# # inference latency
# # plt.title('inference latency by average computing power')
# plt.grid()
# # plt.plot(x, rand_inference_latency, '.-', x, one_inference_latency, '^-', x, min_inference_latency, 'd-', x, comb_inference_latency, '*-', x, lowB_inference_latency, 'x-')
# # plt.plot(x, rand_inference_latency, linestyle='solid', marker='o', markersize=8)
...
#
# # accuracy
# # plt.title('accuracy by average computing power')
# plt.grid()
# # plt.plot(x, rand_accuracy, '.-', x, one_accuracy, '^-', x, min_accuracy, 'd-', x, comb_accuracy, '*-', x, lowB_accuracy, 'x-')
# # plt.plot(x, rand_accuracy, linestyle='solid', marker='o', markersize=8)
...
#
# # energy consumption
# # plt.title('maximum energy consumption by average computing power')
# plt.grid()
# # plt.plot(x, rand_ec, '.-', x, one_ec, '^-', x, min_ec, 'd-', x, comb_ec, '*-', x, lowB_ec, 'x-')
# # plt.plot(x, rand_ec, linestyle='solid', marker='o', markersize=8)
...
# plt.show()
#
# # plt.title('energy consumption of device 1 by average computing power')
# # plt.grid()
# # plt.plot(x, rand_ec_1, '.-', x, one_ec_1, '^-', x, min_ec_1, 'd-', x, comb_ec_1, '*-', x, lowB_ec_1, 'x-')
# # plt.legend(['BASS', 'one-device', 'min-intermediate', 'best computing', 'Low BER'])
# # plt.xlabel('Average computing power')
# # plt.ylabel('energy consumption')
# # plt.show()