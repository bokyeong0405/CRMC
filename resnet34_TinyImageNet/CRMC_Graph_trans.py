...
a = np.load(WHERE_FROM_LOAD + '/eval_burst_infer_trans.npy')
...
a = np.load(WHERE_FROM_LOAD + '/eval_burst_acc_trans.npy')
burst_accuracy = np.array(a[0])
burst_accuracy_std = np.array(a[1])
print(burst_accuracy)
print(burst_accuracy_std)
a = np.load(WHERE_FROM_LOAD + '/eval_burst_energy_trans.npy')
...
##
print("0ne device")
a = np.load(WHERE_FROM_LOAD + '/eval_one_infer_trans.npy')
...
a = np.load(WHERE_FROM_LOAD + '/eval_one_acc_trans.npy')
one_accuracy = np.array(a[0])
one_accuracy_std = np.array(a[1])
print(one_accuracy)
print(one_accuracy_std)
a = np.load(WHERE_FROM_LOAD + '/eval_one_energy_trans.npy')
...
plt.xlabel('average transmission rate (Mbps)')
...
# import matplotlib.pyplot as plt
# # print("BASS")
# # a = np.load('C:/Users/user/PycharmProjects/SplitComputing/eval_rand_infer_trans.npy')
# # rand_inference_latency = np.array(a)
# # print(rand_inference_latency)
# # a = np.load('C:/Users/user/PycharmProjects/SplitComputing/eval_rand_acc_trans.npy')
# # rand_accuracy = np.array(a)
# # print(rand_accuracy)
# # a = np.load('C:/Users/user/PycharmProjects/SplitComputing/eval_rand_energy_trans.npy')
# # rand_energy_consumption = np.array(a)
# # print(rand_energy_consumption)
# # print()
# # rand_ec = []
...
#
# # inference latency
# # plt.title('inference latency by average transmission rate')
# plt.grid()
# # plt.plot(x, rand_inference_latency, '.-', x, one_inference_latency, '^-', x, min_inference_latency, 'd-', x, comb_inference_latency, '*-', x, lowB_inference_latency, 'x-')
# # plt.plot(x, rand_inference_latency, linestyle='solid', marker='o', markersize=8)
...
# plt.show()
# #
# # print("comb", comb_inference_latency)
# # print("bass",rand_inference_latency)
#
# # accuracy
# # plt.title('accuracy by average transmission rate')
# plt.grid()
# # plt.plot(x, rand_accuracy, '.-', x, one_accuracy, '^-', x, min_accuracy, 'd-', x, comb_accuracy, '*-', x, lowB_accuracy, 'x-')
# # plt.plot(x, rand_accuracy, linestyle='solid', marker='o', markersize=8)
...
#
# # energy consumption
# # plt.title('maximum energy consumption by average transmission rate')
# plt.grid()
# # plt.plot(x, rand_ec, '.-', x, one_ec, '^-', x, min_ec, 'd-', x, comb_ec, '*-', x, lowB_ec, 'x-')
# # plt.plot(x, rand_ec, linestyle='solid', marker='o', markersize=8)
...
# plt.show()
#
# # plt.title('energy consumption of device 1 by average etransmission rate')
# # plt.grid()
# # plt.plot(x, rand_ec_1, '.-', x, one_ec_1, '^-', x, min_ec_1, 'd-', x, comb_ec_1, '*-', x, lowB_ec_1, 'x-')
# # plt.legend(['BASS', 'one-device', 'min-intermediate', 'best computing', 'Low BER'])
# # plt.xlabel('Average transmission rate')
# # plt.ylabel('energy consumption')
# # plt.show()